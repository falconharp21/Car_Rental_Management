...
<head>
    <title> Admin Signup | Wheels On The Way  </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Wheels On The Way - Registration</h1>
            <br>
            <p class="text-center">Create an admin account here</p>
        </div>
    </div>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="client_name" type="text" name="client_name" placeholder="Enter Your Name" required="" autofocus="">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn btn-success"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn btn-success"><span class="glyphicon glyphicon-contact" aria-hidden="true"></span></label>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                  <label class="btn btn-success"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
              </span>
                                    </span>
                                </div>
                            </div>
                  ...
                  <label class="btn btn-success"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <label style="margin-left: 5px;"><a href="clientlogin.php">Have an account..Login Here</a></label>
