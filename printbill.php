...
?>
    ...
    <h2 class="text-center"> Thank you for visiting WOW - Wheels On The Way! We wish you have a safe ride...</h2>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: orange;">Your booking has been received</h3>
                <br>
