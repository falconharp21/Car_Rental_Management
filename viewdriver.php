...
<body>
 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: #42D548; color:#ffffff">
    ...
    <div class="form-area" style="padding: 40px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Driver Details</h3>
<?php
// Storing Session
