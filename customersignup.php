...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <p class="text-center">Create an user account</p>
        </div>
    </div>
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="customer_name"><span class="text-danger" style="margin-right: 5px;">*</span> NAME </label>
                                <div class="input-group">
                                    <input class="form-control" id="customer_name" type="text" name="customer_name" placeholder="Enter Your Name" required>
