...
?>
    ...
    <head>
        <title> User Login | Wheels On The Way </title>
    </head>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: #42D548; color:#ffffff">
        ...
        <div class="container">
            <div class="jumbotron">
            <h1 class="text-center">User Login | Wheels On The Way </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn btn-success"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <label style="margin-left: 5px;"><a href="customersignup.php">Create a new account..SignUp Here</a></label>
                        </form>
                    </div>
                </div>
            </div>
